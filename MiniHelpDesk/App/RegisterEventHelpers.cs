...
{
    public static bool CheckAllFieldsRegister(string txtUsername, string txtEmail, string txtPassword, string txtConfirmPassword)
    {
    ...
    public static bool CheckAllFieldsLogin(string txtUsername, string txtPassword)
    {
        return string.IsNullOrWhiteSpace(txtUsername) ||
               string.IsNullOrWhiteSpace(txtPassword);
    }
